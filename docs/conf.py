...
:ref:`manual <man>` - :ref:`reconsider <reconsider>` - :ref:`request <request>` - :ref:`guilty <guilty>` - :ref:`evidence <evidence>` - :ref:`writing <writings>` - :ref:`source <source>` - `icc <https://www.icc-cpi.int/>`_ - `statute <https://www.icc-cpi.int/sites/default/files/Publications/Rome-Statute.pdf>`_ - `pypi <http://pypi.org/project/gneocide>`_ - `\! <http://github.com/bthate/genocide>`_
