...
.. raw:: html
    ...
    greffe and king's kabinet, writing back that "the king took note of what i have
    written (zyprexa is poison)".
    <br><br>
    This makes the care laws used in the netherlands to provide care to elderly and
    handicapped, criminals and psychiatric patients not care laws but genocide laws with 
